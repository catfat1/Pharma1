...
<script>
// $(document).ready(function(){
    // $("#modalFormEdit").on('shown', function (e) {
    //         console.log('yarab');
           
    // });
    // $(document).on('show.bs.modal','#modalFormEdit', function () {
    //   alert('hi');
    // });
// });
$(document).ready(function(){
$('#modalFormEdit').on('hide.bs.modal', function (e) { 
    console.log();
    alert('hi');
});
});
